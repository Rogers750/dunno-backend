...
const SHIRT_BUDGETS = ["500-1000", "1000-1600", "1600-2500", "Budget Not A Bar"];

export default function ShirtsBudgetRangeScreen() {
  ...
  const saveBudget = async () => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/user/profile`, {
        ...
        body: JSON.stringify({ shirt_budget_range: selected }),
      });
      if (res.ok) {
        router.replace("/profile/shoppreference");
      }
    } catch (error) {
      console.error("Error saving shirt budget:", error);
    }
  };
        ...
        <FlatList
          ...
          ListFooterComponent={
            <View style={styles.footer}>
              {selected ? (
                <TouchableOpacity style={styles.continueButton} onPress={saveBudget}>
